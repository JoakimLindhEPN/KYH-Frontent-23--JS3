    ...
    <div className="flex items-center justify-center h-full max-w-96 mx-auto">
      <form onSubmit={onSubmit} className="shadow-md bg-white rounded-md">
        <header className="text-center border-b p-4">
          <h2 className="text-2xl font-bold">Registrera användare</h2>
          <p className="text-sm">När du har registrerat dig så kommer du få tillgång till din unika api-nyckel</p>
        </header>
        <div className="p-4">
          <div className="mb-3">
          ...
          <div className="mb-3">
            ...
            <input type="password" id="repeatPassword" className="w-full border p-1 rounded" value={formData.repeatPassword} onChange={onChange} />
            {formErrors.repeatPassword && <p className="text-red-500 text-sm">{formErrors.repeatPassword}</p>}
          </div>
          <div className="flex mt-6">
            <button className="bg-slate-800 text-white px-5 py-2 rounded ml-auto">Registrera</button>
          </div>
